...
namespace TicTacToe
{
	...
	public:
		...
		vector<TriStateGameBoard> GetFutureBoards(BoardState player);
	...
	private:
		...
		TriStateGameBoard CopyBoard(TriStateGameBoard board);
		bool IsTerminalNode();
		int16_t mLastRowMove = 0;
		int16_t mLastColMove = 0;
		int16_t mBoardValue = 0;
		BoardState GetOtherPlayer(BoardState player);
